package com.strongman.tablayout;
...
import com.strongman.tablayout.utils.UnreadMsgUtils;
import com.strongman.tablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.SlidingTabLayout_tl_message_textSize, 12);
        mMsgTextColor = ta.getColorStateList(R.styleable.SlidingTabLayout_tl_message_textColor);
        ta.recycle();
    }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            lp.topMargin = getHeight() > 0 ? (int) (getHeight() - textHeight) / 2 - dp2px(bottomPadding) : 0;
